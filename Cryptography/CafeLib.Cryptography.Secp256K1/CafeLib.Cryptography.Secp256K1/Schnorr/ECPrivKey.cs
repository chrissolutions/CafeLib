...
namespace CafeLib.Cryptography.Secp256K1.Schnorr
{
	/// <summary>
	...
	partial class ECPrivKey
	{
		...
		public bool TrySignBIP340(ReadOnlySpan<byte> msg32, Secp256K1.ECPubKey? pubkey, INonceFunctionHardened? nonceFunction, [System.Diagnostics.CodeAnalysis.MaybeNullWhen(false)] out SecpSchnorrSignature signature)
		{
			signature = null;
			if (msg32.Length != 32)
				return false;
