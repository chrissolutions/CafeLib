...
using System;
using System.Linq;
using CafeLib.Cryptography.Secp256K1.Schnorr;
...
namespace CafeLib.Cryptography.Secp256K1.Musig
{
	...
	class MusigContext
	{
		...
		private Secp256K1.ECXOnlyPubKey[] pubKeys;
		private MusigPubNonce? combinedNonce;
		public MusigPubNonce? CombinedNonce => combinedNonce;
		public Secp256K1.ECXOnlyPubKey CombinedPubKey => combinedPubKey;
		ECPubKey? tweakedPubKey;
		Secp256K1.ECXOnlyPubKey? xonlyTweakedPubKey;
		public ECPubKey? TweakedPubKey => tweakedPubKey;
		public Secp256K1.ECXOnlyPubKey? XOnlyTweakedPubKey => xonlyTweakedPubKey ??= tweakedPubKey?.ToXOnlyPubKey();


		public Secp256K1.ECXOnlyPubKey SigningPubKey => XOnlyTweakedPubKey ?? CombinedPubKey;
		private Secp256K1.ECXOnlyPubKey combinedPubKey;
		private Context ctx;
		...
		internal MusigContext(Secp256K1.ECXOnlyPubKey[] pubKeys, ReadOnlySpan<byte> msg32)
		{
			if (pubKeys == null)
		...
		public bool Verify(Secp256K1.ECXOnlyPubKey pubKey, MusigPubNonce pubNonce, MusigPartialSignature partialSignature)
		{
