...
namespace CafeLib.Data.Sources.Extensions
{
    public static class ConnectionInfoExtensions
    {
        ...
        {
            return await connectionInfo.Options.CommandProvider.DeleteAsync(connectionInfo, data, token);
        }
        ...
        {
            return await connectionInfo.Options.CommandProvider.ExecuteAsync(connectionInfo, sql, parameters, token);
        }
        ...
        {
            return await connectionInfo.Options.CommandProvider.ExecuteQueryAsync<T>(connectionInfo, sql, parameters, token);
        }
        ...
        {
            return await connectionInfo.Options.CommandProvider.ExecuteSave<TKey>(connectionInfo, sql, parameters, token);
        }
        ...
        {
            return await connectionInfo.Options.CommandProvider.InsertAsync(connectionInfo, data, token);
        }
        ...
        {
            return await connectionInfo.Options.CommandProvider.UpdateAsync(connectionInfo, data, token);
        }
        ...
        {
            return await connectionInfo.Options.CommandProvider.UpsertAsync(connectionInfo, data, expressions, token);
        }
