...
namespace CafeLib.Data.Sources.Sqlite
{
    ...
    {
        private static readonly SqlCommandProvider<SQLiteConnection> SqlCommandProvider = new();
        ...
        {
            return await SqlCommandProvider.QueryCountAsync<TEntity>(connectionInfo, token).ConfigureAwait(false);
        }
