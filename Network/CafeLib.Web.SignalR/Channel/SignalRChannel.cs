...
using CafeLib.Web.SignalR.Logging;
using Microsoft.AspNetCore.SignalR.Client;
using Microsoft.AspNetCore.SignalR.Protocol;

namespace CafeLib.Web.SignalR.Channel
{
    public abstract class SignalRChannel : RunnerBase, ILogEventReceiver
    {
        ...
        private readonly SignalRChannelLogFactory _logFactory;
        ...
        protected SignalRChannel(string url, MethodBridge bridge, Action<LogEventMessage> eventListener = null)
            : base(DefaultDelay)
        {
            _logFactory = new SignalRChannelLogFactory(url, this);
            Url = new Uri(url);
            Bridge = bridge;
        ...
        {
            SetState(message as SignalRChannelLogEventMessage);
        ...
        private async Task ConnectChannel()
        {
            ...
            Connection = new HubConnection(new SignalRChannelConnectionFactory(Url, _logFactory), new JsonHubProtocol(), _logFactory);
        ...
        private void SetState(SignalRChannelLogEventMessage message)
        {
