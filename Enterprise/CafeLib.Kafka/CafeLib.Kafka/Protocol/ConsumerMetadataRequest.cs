...
namespace CafeLib.Kafka.Protocol
{
    ...
    {
        public ApiKeyRequestType ApiKey => ApiKeyRequestType.ConsumerMetadataRequest;
        ...
        private static IEnumerable<ConsumerMetadataResponse> DecodeConsumerMetadataResponse(IEnumerable<byte> data)
        {
