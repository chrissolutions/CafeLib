...
namespace CafeLib.Bitcoin.Shared.Crypto
{
    public static partial class Hashes
    {
        ...
        public static KzUInt160 Sha1(this ReadOnlyByteSpan data)
        {
        ...
        public static KzUInt256 Hash256(this ReadOnlyByteSpan data)
        {
        ...
        {
            return Ripemd160((ReadOnlyByteSpan) Sha256(data).Bytes);
        }
        ...
        public static KzUInt256 HmacSha256(this ReadOnlyByteSpan key, ReadOnlyByteSpan data)
        {
            var h = new KzUInt256();
            new HMACSHA256(key).TransformFinalBlock(data, h.Span);
            return h;
        }
