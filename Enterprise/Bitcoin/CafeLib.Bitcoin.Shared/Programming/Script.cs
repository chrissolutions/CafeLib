...
namespace CafeLib.Bitcoin.Shared.Programming
{
    ...
    public struct Script
    {
        ...
        private Script(ReadOnlySequence<byte> script) : this()
        {
            _script = script;
        }
        ...
        public Script Slice(SequencePosition start, SequencePosition end) => new Script(_script.Slice(start, end));

        internal ReadOnlyByteSequence Sequence => _script;
