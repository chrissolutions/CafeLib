...
namespace CafeLib.Bitcoin.UnitTests.Keys
{
    public class KzBip32Tests
    {
        ...
        TV[] tvs = new TV[] {
            ...
            new TV {
                m = "fffcf9f6f3f0edeae7e4e1dedbd8d5d2cfccc9c6c3c0bdbab7b4b1aeaba8a5a29f9c999693908d8a8784817e7b7875726f6c696663605d5a5754514e4b484542",
                tds = new [] {
                    new TD {
                        p = "m",
                    ...
                    new TD {
                        p = "m/0/2147483647H/1/2147483646H",
                    ...
                    new TD {
                        p = "m/0/2147483647H/1/2147483646H/2",
            ...
            new TV {
                m = "4b381541583be4423346c643850da4b320e46a87ae3d2a4e6da11eba819cd4acba45d239319ac14f863b8d5ab5a0d0c64d2e8a1e7d1457df2e5a3c51c73235be",
                tds = new [] {
                    new TD {
                        p = "m",
