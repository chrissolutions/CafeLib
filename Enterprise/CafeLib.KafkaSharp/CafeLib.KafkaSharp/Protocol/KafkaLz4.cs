...
namespace CafeLib.KafkaSharp.Protocol
{
    ...
    /// 
    /// </summary>
    internal static class KafkaLz4
    {
        /// <summary>
        /// Hardcoded frame descriptor (configuration is static).
        /// </summary>
        ...
        static KafkaLz4()
        {
            MaxCompressedSize = LZ4Codec.MaximumOutputLength(BlockSize);
        }
        ...
        public static void Compress(ReusableMemoryStream target, byte[] body, int count)
        {
            ...
            {
                BlockCompress(target, body, count - left, BlockSize);
                left -= BlockSize;
            }
